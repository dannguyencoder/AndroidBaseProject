...
public abstract class EndlessListViewScrollListener implements AbsListView.OnScrollListener {
    ...
    //The minimum number of items to have below your scroll position
    //before loading more
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        //If the total item count is zero and the previous isn't, assume the list
        //is invalidated and should be reset back to initial state
    ...
    //Returns true if more data is being loading; return false if there is no more data to load
