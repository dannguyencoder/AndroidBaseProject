...
public abstract class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        //changed, if so we conclude it has finished loading and update
        //the current page number and total item count
    ...
    protected abstract void onLoadMore(int currentPage, int totalItemCount, RecyclerView recyclerView);
}
